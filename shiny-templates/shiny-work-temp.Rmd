...
Then I changed the choices parameter in the first input selector, for "Friends:"
...
To create this new app, I copied the `hello-world-1a` directory and app and renamed the copy `hello-world-1b`. Then within the output$greetingText function, I changed the phrase that is pasted before the friend name and punctuation from "Hello " to "Hey ". 
...
I also added code to plot the correlation using ggplot rather than base R for more customization fun
